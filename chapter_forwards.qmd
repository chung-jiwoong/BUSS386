...
-   In this settlement, the exchange pays or receives cash to compensate for the price difference.
    ...
    -   When moving from the old $(F\_0=1250)$ to the new $(F\_1=1255)$, the long-position investor receives \$5.
:::
:::
...
![](img/forwards_gold.png){fig-align="center"}
...
-   Example
    ...
    -   On March 1, a U.S. company expects to receive 50 million yen at the end of July.
    -   Yen futures contracts are available for March, June, September, and December, with each contract covering 12.5 million yen.
    -   The company shorts four September yen futures contracts on March 1.
    ...
    -   The gain on the futures contract is $0.0550$ cents per yen, and the basis is $1.02000-1.02500=-0.0050$ cents per yen.
...
-   An airline expects to purchase two million gallons of jet fuel in one month and decides to use heating oil futures for hedging. The standard deviation of futures price is \$\sigma\_F=0.0313\$, the standard deviation of jut fuel price is \$\sigma\_S=0.0263\$, and the correlation coefficient is \$\rho=0.928\$.
